...
const zhCN: Dict = {
  ...
  toast_movedN: "已移动 {n} 个画板",
  toast_copiedN: "已复制 {n} 个画板",
  ...
  agent_relayNotFound: "未检测到本地中继，请先启动 bridge-relay.mjs 或 KaiBoard Companion。",
  ...
  agent_enabledNote: "已启用：页面正在轮询本地中继；请在同一台电脑启动 bridge-relay.mjs 或 KaiBoard Companion，并把上面的「中继令牌」复制到你 Agent 的 MCP 配置（环境变量 KAIBOARD_TOKEN）。",
...
const zhTW: Dict = {
  ...
  toast_movedN: "已移動 {n} 個畫板",
  toast_copiedN: "已複製 {n} 個畫板",
  ...
  agent_relayNotFound: "未偵測到本地中繼，請先啟動 bridge-relay.mjs 或 KaiBoard Companion。",
  ...
  agent_enabledNote: "已啟用：頁面正在輪詢本地中繼；請在同一台電腦啟動 bridge-relay.mjs 或 KaiBoard Companion，並把上面的「中繼令牌」複製到你 Agent 的 MCP 設定（環境變數 KAIBOARD_TOKEN）。",
...
const en: Dict = {
  ...
  toast_movedN: "Moved {n} board(s)",
  toast_copiedN: "Copied {n} board(s)",
  ...
  agent_relayNotFound: "No local relay detected. Start bridge-relay.mjs or KaiBoard Companion on this machine.",
  ...
  agent_enabledNote: "Enabled: the page is polling the local relay. Start bridge-relay.mjs or KaiBoard Companion on this machine, and copy the 'Relay token' above into your Agent's MCP config (env KAIBOARD_TOKEN).",
